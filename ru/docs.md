...
Отрицательное математическое ожидание ($EV_{\text{mine}} = -12.5\%$) является фундаментальным элементом экономической модели PARADOX. Оно обеспечивает дефляционный характер системы, поскольку в среднем приводит к сокращению общего количества PRDX в обращении. Это сокращение создает давление в сторону роста стоимости токена, принося пользу всем держателям.
